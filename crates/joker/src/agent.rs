...
use crate::{
    ...
    ContextInput, Event, Model, ModelError, ModelRequest, ModelResponseEvent, NoopObserver,
    ...
    ToolResult, agent_config::AgentConfig, agent_types::TurnOutcome,
};
...
impl AgentBuilder {
    ...
    pub fn tools(mut self, tools: Arc<ToolRegistry>) -> Self {
        tracing::debug!(target: "agent", "builder: tools set");
    ...
    pub fn context_builder(mut self, context_builder: Arc<dyn ContextBuilder>) -> Self {
        tracing::debug!(target: "agent", "builder: context_builder set");
    ...
    pub fn permissions(mut self, policy: Arc<dyn ToolPolicy>) -> Self {
        tracing::debug!(target: "agent", "builder: permissions set");
    ...
    pub fn observer(mut self, observer: Arc<dyn Observer>) -> Self {
        tracing::debug!(target: "agent", "builder: observer set");
    ...
    pub fn approval_channel(mut self, channel: SharedApprovalChannel) -> Self {
        tracing::debug!(target: "agent", "builder: approval_channel set");
        self.approval_channel = Some(channel);
        self
    }
    /// Set the [`AgentConfig`].
    ...
    pub fn config(mut self, config: AgentConfig) -> Self {
        tracing::debug!(target: "agent", "builder: config set");
